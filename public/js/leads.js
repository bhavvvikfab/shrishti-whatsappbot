(function () {
    ...
    function init() {
        ...
        function authHeaders(extraHeaders) {
            return window.crmApplyAuthHeaders({
        ...
        function renderRows(items, meta) {
                ...
                tableBody.innerHTML = `
                    <tr>
                        <td colspan="7" class="text-center py-5">
                            ...
                            ${permissions.create ? '<a href="/leads/create" class="btn btn-dark-blue btn-sm rounded-pill px-4">Create Your First Lead</a>' : ''}
                        </td>
                    </tr>`;
                return;
            }
            ...
            tableBody.innerHTML = items.map(function (lead, index) {
                ...
                const sourceText = lead.lead_source?.name || lead.leadSource?.name || lead.source || "-";
                ...
                const waChatBtn = lead.whatsapp_chat_url
                    ? `<a href="${lead.whatsapp_chat_url}" class="btn btn-outline-success btn-sm crm-action-btn" title="Open WhatsApp chat"><i class="fab fa-whatsapp"></i></a>`
                    : "";
                const waNameIcon = lead.whatsapp_chat_url
                    ? `<a href="${lead.whatsapp_chat_url}" class="text-success ms-1 align-middle" title="WhatsApp conversation"><i class="fab fa-whatsapp"></i></a>`
                    : "";
                        ...
                        <td colspan="8" class="p-0 border">
                            <div class="details-content">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 d-flex justify-content-between align-items-center">
                                        <div class="expand-label"><i class="fa-solid fa-bullhorn"></i> Source :</div>
                                        <div class="expand-value">${sourceText}</div>
                                    </div>
                                    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        function fetchLeads(page = 1) {
            ...
            $.ajax({
                ...
                error: function () {
                    tableBody.innerHTML = `
                        <tr>
                            <td colspan="7" class="text-center py-5">Error loading leads</td>
                        </tr>`;
                },
            });
        }
...
$(document).ready(function () {
    ...
    $('body').on('submit', '.ajax-lead-form', function (e) {
        ...
        $.ajax({
            ...
            processData: false,
            contentType: false,
            headers: window.crmApplyAuthHeaders({
