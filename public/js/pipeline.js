                ...
                tableBody.innerHTML = `
                    <tr>
                        <td colspan="7" class="text-center py-5">
                            ...
                            ${permissions.create ? '<a href="/pipeline/create" class="btn btn-dark-blue btn-sm rounded-pill px-4">Create Your First Pipeline</a>' : ''}
                        </td>
                    </tr>`;
                return;
            }
