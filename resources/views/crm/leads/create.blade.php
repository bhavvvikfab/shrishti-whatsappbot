        ...
        <div class="card shadow-sm border-0 rounded-4 overflow-hidden lead-form-card">
            <div class="card-header bg-white border-bottom py-3 px-3 px-md-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    ...
                    <a href="{{ route('leads.index') }}" class="btn btn-dark-blue lead-back-btn">
            ...
            <form method="POST" action="/api/leads" enctype="multipart/form-data" class="needs-validation ajax-lead-form" novalidate id="leadCreateForm">
                @csrf

                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Name <span class="text-danger">*</span></label>
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Lead Name" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone Number" required>
                        <div class="invalid-feedback" id="phone-error">@error('phone') {{ $message }} @enderror</div>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">WhatsApp</label>
                        <input type="text" name="whatsapp" id="whatsapp" value="{{ old('whatsapp') }}" class="form-control @error('whatsapp') is-invalid @enderror" placeholder="WhatsApp Number">
                        <div class="invalid-feedback" id="whatsapp-error">@error('whatsapp') {{ $message }} @enderror</div>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Address <span class="text-danger">*</span></label>
                        <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="1" placeholder="Lead Address" required>{{ old('address') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="border rounded bg-light d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; flex-shrink: 0;">
                                <img id="leadImagePreview" src="" class="w-100 h-100 object-fit-cover rounded d-none" alt="Preview">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="company_name" id="company_name" value="{{ old('company_name') }}" class="form-control @error('company_name') is-invalid @enderror" placeholder="Company Name">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sic_code" id="sic_code" value="{{ old('sic_code') }}" class="form-control @error('sic_code') is-invalid @enderror" placeholder="SIC Code">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="source" id="source" value="{{ old('source') }}" class="form-control @error('source') is-invalid @enderror" placeholder="Lead Source" required>
                        <div class="invalid-feedback" id="source-error">@error('source') {{ $message }} @enderror</div>
                    </div>

                    <div class="col-12 col-md-6">
                        <label class="form-label fw-semibold">Comment</label>
                        <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror" rows="2" placeholder="Comments">{{ old('notes') }}</textarea>
