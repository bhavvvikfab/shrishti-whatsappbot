        ...
        <div class="card shadow-sm border-0 rounded-4 overflow-hidden pipeline-form-card">
            <div class="card-header bg-white border-bottom py-3 px-3 px-md-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    <div>
                        <h1 class="h4 mb-1 fw-semibold">Add Pipeline</h1>
                        <p class="text-muted small mb-0">Create a new pipeline entry.</p>
                    </div>
                    <a href="{{ route('pipeline.index') }}" class="btn btn-dark-blue pipeline-back-btn">
            ...
            <form method="POST" action="/api/pipelines" id="pipelineForm" class="needs-validation mb-0" novalidate>
                @csrf
                <div class="row g-3">
                    <div class="col-12">
