            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="sendEmailForm">
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                <label class="form-label m-0">Email Subject <span class="text-danger">*</span></label>
                                <input type="text" name="subject" id="subject" class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label m-0">Select Customers <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12">
                                <label class="form-label m-0">Select Template <span class="text-danger">*</span></label>
